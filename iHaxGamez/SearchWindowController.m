...
- (IBAction)MemoryViewerClicked:(id)sender
{
	MemoryViewerController* myMemoryViewer = [[[MemoryViewerController alloc] initWithAppName:applicationName PID:AppPid] autorelease];
}
